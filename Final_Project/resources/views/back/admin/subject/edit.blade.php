...
<div class="content container-fluid">
  <div class="row">
      <div class="col-sm-12">
          <h4 class="page-title"> Update<span class="text-primary"> {{ $old_info->unit_name }}</span> Subject</h4>
      </div>
  </div>
  <div class="row">
            ...
            @endif
              ...
              <form action="{{route('subjectupdate')}}" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control{{ $errors->has('subject_name') ? ' is-invalid' : '' }}" placeholder="Enter Subject Name" name="subject_name" value="{{ $old_info->subject_name }}" required>
                      <input type="hidden" name="subject_id" value="{{ $old_info->id }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control{{ $errors->has('seat') ? ' is-invalid' : '' }}" placeholder="Enter Number of seats" name="seat" value="{{ $old_info->seat }}" required>
                      @if ($errors->has('seat'))
                          <span class="invalid-feedback" role="alert">
