            ...
            <form action="{{route('university.store')}}" method="post">
              @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control{{ $errors->has('university_description') ? ' is-invalid' : '' }}" placeholder="Enter University Description" name="university_description">{{ old('university_description') }}</textarea>
